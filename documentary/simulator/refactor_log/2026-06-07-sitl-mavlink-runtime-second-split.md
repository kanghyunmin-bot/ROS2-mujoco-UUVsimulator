...
Scope: active runtime MAVLink transport code under `sim/current/bridge`.
...
python3 -m py_compile \
  sim/current/bridge/sitl_mavlink_runtime.py \
  sim/current/bridge/sitl_mavlink_connection.py \
  sim/current/bridge/sitl_mavlink_telemetry.py \
  sim/current/bridge/sitl_mavlink_polling.py \
