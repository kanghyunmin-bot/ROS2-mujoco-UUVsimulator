...
Behavior-neutral split inside the active runtime `sim/current`.  This
...
python3 -m py_compile \
  sim/current/bridge/ping360_sim.py \
  sim/current/bridge/ping360_profile.py \
  sim/current/bridge/ping360_beam_model.py \
  sim/current/gui/ros_process_mixin.py \
  sim/current/gui/ros_panel_mixin.py \
  sim/current/gui/ros_logged_process_mixin.py \
