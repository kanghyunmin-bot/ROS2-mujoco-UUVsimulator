...
```text
python3 -m compileall -q sim/current/tools/filter_ping360_stl*.py
python3 sim/current/tools/filter_ping360_stl.py --help
python3 - <<'PY'
import sys
from pathlib import Path
sys.path.insert(0, str(Path('sim/current/tools').resolve()))
from filter_ping360_stl_io import read_binary_stl, compute_bbox
path = Path('sim/current/assets/ping360/ping360_body_no_cable.stl')
