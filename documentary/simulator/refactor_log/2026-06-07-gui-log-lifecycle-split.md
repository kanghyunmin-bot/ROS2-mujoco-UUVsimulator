...
git diff --check
python3 sim/current/tools/check_rc_frame_contract.py
python3 sim/current/tools/check_gui_readiness_contract.py
python3 sim/current/tools/check_gui_backend_selection.py
...
python3 sim/current/tools/refactor_inventory.py \
  --root sim/current --format markdown --limit 25
```
