...
```text
python3 -m compileall -q sim/current/bridge/ros2_mavros_command_services.py sim/current/bridge/ros2_command_payload.py sim/current/bridge/ros2_mavros_setpoint_services.py sim/current/bridge/ros2_mavros_arm_mode_services.py sim/current/bridge/ros2_sitl_command_override.py
