...
```text
env PYTHONPYCACHEPREFIX=/private/tmp/pycache python3 -m compileall -q sim/current/gui
...
env PYTHONPYCACHEPREFIX=/private/tmp/pycache PYTHONPATH=sim/current/tools python3 sim/current/tools/audit_code_contract_sources.py --out-dir /private/tmp/uuv_source_audit_ros_panel_split_20260610
