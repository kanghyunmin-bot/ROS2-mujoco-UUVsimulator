...
PYTHONPATH=sim/current/tools python3 sim/current/tools/audit_code_contract_sources.py --out-dir /private/tmp/uuv_code_contract_after_dynamic_fluidcoef_split
python3 sim/current/tools/check_dev_os_compat.py --headless --target-os ubuntu
source ./.uuv_mujoco_env.sh && PYTHONPATH=sim/current/tools "$MJ311_PYTHON" sim/current/tools/physics_contract_audit.py --output-dir /private/tmp/uuv_physics_contract_after_dynamic_fluidcoef_split --simulate-s 0
```
