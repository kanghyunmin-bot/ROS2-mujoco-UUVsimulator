...
`sim/current` plus `uuv_mujoco/RUNTIME_VERSION.json`; the backing
...
- `sim/current` remains the active launch/runtime path.
...
PYTHONPATH=sim/current/tools python3 sim/current/tools/audit_code_contract_sources.py --out-dir /private/tmp/uuv_source_audit_spaghetti_goal_next
...
/Users/kanghyunmin/miniconda3/envs/ros2_h311/bin/python sim/current/tools/physics_contract_audit.py --output-dir /private/tmp/uuv_physics_audit_spaghetti_goal_next --simulate-s 0
git diff --check
```
