...
```text
python3 -m py_compile sim/current/tools/roll_stability_sweep.py \
  sim/current/tools/roll_stability_candidates.py \
  sim/current/tools/roll_stability_file_edits.py \
  sim/current/tools/roll_stability_metrics.py \
  sim/current/tools/roll_stability_probe.py \
  sim/current/tools/roll_stability_runner.py
PYTHONPATH=sim/current/tools python3 sim/current/tools/roll_stability_sweep.py --help
PYTHONPATH=sim/current/tools python3 <non-ROS helper smoke>
