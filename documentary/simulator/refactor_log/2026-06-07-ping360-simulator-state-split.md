...
```text
python3 -m compileall -q sim/current/bridge/ping360_sim.py ...
PYTHONPATH=sim/current /Users/kanghyunmin/miniconda3/envs/ros2_h311/bin/python - <<'PY'  # MuJoCo XML smoke
