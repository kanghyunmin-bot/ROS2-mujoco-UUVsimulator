...
Scope: active runtime physics setup under `sim/current/sim/physics`.
...
python3 -m py_compile \
  sim/current/sim/physics/model_setup.py \
  sim/current/sim/physics/fluid_option_runtime.py \
  sim/current/sim/physics/pool_runtime_overrides.py \
  sim/current/sim/physics/fluid_geom_runtime.py \
  sim/current/sim/physics/body_tree.py \
  sim/current/sim/runtime/model_runtime_setup.py \
