...
Scope: active runtime transport replay code under `sim/current/bridge`.
...
python3 -m py_compile \
  sim/current/bridge/sitl_replay.py \
  sim/current/bridge/sitl_replay_types.py \
  sim/current/bridge/sitl_replay_common.py \
  sim/current/bridge/sitl_replay_loaders.py \
  sim/current/bridge/sitl_replay_interpolation.py \
  sim/current/bridge/sitl_initialization.py
