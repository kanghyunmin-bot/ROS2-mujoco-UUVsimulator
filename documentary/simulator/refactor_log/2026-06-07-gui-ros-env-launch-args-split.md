...
python3 -m compileall -q \
  ...
  sim/current/gui/ros_python_runtime.py \
  sim/current/gui/ros_setup_paths.py \
  sim/current/gui/ros_bash.py \
  sim/current/gui/ros_tools.py \
  sim/current/gui/sim_stack_env_args.py \
  sim/current/gui/sim_stack_initial_depth_args.py \
  sim/current/gui/sim_stack_extra_args.py \
  sim/current/gui/sim_stack_launch_args.py \
  sim/current/gui/sim_stack_env.py
