...
bash -n run_control_gui.sh run_control_gui_ubuntu.sh \
  sim/current/start_sitl_mujoco_mj311.sh \
  sim/current/run_control_gui.sh \
  sim/run_mujoco.sh \
...
python3 -m py_compile \
  ...
  sim/current/tools/runtime_freshness_report.py
...
sim/current/start_sitl_mujoco_mj311.sh --help
