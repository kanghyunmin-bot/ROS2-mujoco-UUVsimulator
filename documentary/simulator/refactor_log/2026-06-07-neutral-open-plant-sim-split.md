...
python3 -m compileall -q \
  sim/current/tools/physics_contract_neutral_sim.py \
  sim/current/tools/physics_contract_neutral_buoyancy.py \
  sim/current/tools/physics_contract_neutral_output.py \
