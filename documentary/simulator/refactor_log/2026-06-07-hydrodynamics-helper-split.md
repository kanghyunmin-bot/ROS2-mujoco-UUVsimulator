...
```text
python3 -m compileall -q sim/current/physics/hydrodynamics*.py \
  sim/current/physics/thruster_curve_helpers.py \
  sim/current/physics/hydrostatic_fraction_helpers.py \
