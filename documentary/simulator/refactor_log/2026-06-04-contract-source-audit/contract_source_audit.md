...
- local evidence:
  - `uuv_mujoco/v2.2/bridge/sitl_contract.py:82` - sitl_depth_m_for_frontend_match
  ...
  - `uuv_mujoco/v2.2/bridge/sitl_transport.py:3010` - json_position[2] = float(vertical_est.depth_m)
...
- official refs: <https://ardupilot.org/dev/docs/sitl-with-JSON.html>
- local evidence:
  - `uuv_mujoco/v2.2/bridge/sitl_transport.py:3014` - "altitude": float(vertical_est.alt_m)
