...
```text
python3 -m compileall -q sim/current/bridge/sitl_arm_mode_runtime.py sim/current/bridge/sitl_arm_mode_send.py sim/current/bridge/sitl_arm_mode_queue.py sim/current/bridge/sitl_arm_mode_service.py
