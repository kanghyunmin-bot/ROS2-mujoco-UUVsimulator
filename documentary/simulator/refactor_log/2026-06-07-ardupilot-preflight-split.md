...
```text
PYTHONPATH=sim/current/tools python3 <preflight classify smoke>
python3 sim/current/tools/preflight_ardupilot_integrity.py --help
python3 sim/current/tools/preflight_ardupilot_integrity.py --workspace . --allow-dirty --json-out /tmp/uuv_ardupilot_preflight_smoke.json
