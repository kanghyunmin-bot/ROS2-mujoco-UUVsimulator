...
`sim/current`.  This does not change the ArduSub source, submodule
...
python3 -m py_compile \
  sim/current/bridge/sitl_rc_manual_runtime.py \
  sim/current/bridge/sitl_rc_override_runtime.py \
  sim/current/bridge/sitl_manual_control_runtime.py \
  sim/current/bridge/sitl_guided_setpoint_runtime.py \
