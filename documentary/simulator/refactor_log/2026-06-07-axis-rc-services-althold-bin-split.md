...
python3 -m compileall -q \
  ...
  sim/current/tools/axis_rc_service_spin.py \
  sim/current/tools/axis_rc_stack_wait.py \
  sim/current/tools/axis_rc_mode_service.py \
  sim/current/tools/axis_rc_arm_service.py \
  sim/current/tools/axis_rc_trigger_service.py \
  sim/current/tools/axis_rc_node_services.py

axis_rc_services_split_smoke PASS

python3 -m compileall -q \
  sim/current/tools/althold_contract_bin.py \
  sim/current/tools/althold_contract_bin_schema.py \
  sim/current/tools/althold_contract_bin_paths.py \
  sim/current/tools/althold_contract_bin_streams.py \
  sim/current/tools/althold_contract_bin_reader.py \
  sim/current/tools/althold_contract_signal_math.py \
