...
DEFAULT_SIM_BAG = Path(
    ...
    "runs/closed_loop/closed_loop_bar30_external_from_start_20260504/sim_bag/sim_bag_0.db3"
)
DEFAULT_OUT = Path(
    ROOT / "document/docsource/"
    "runs/closed_loop/closed_loop_bar30_external_from_start_20260504/command_mapped_diagnostics"
)
