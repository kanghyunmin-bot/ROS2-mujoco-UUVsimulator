...
MEAS_CUSTOM_PATH = DOCSRC_DIR / "measurement_custom_mode_path_latest.json"
MEAS_ELLIPSOID_PATH = DOCSRC_DIR / "measurement_ellipsoid_mode_path_latest.json"
ENGINE_METRICS_PATH = DOCSRC_DIR / "engine_comparison_metrics.json"
