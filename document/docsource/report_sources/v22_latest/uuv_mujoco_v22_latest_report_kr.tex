...
\begin{itemize}[leftmargin=2em]
  \item \code{document/docsource/metrics/report_inputs/uuv_v22_latest_report_metrics.json}
  \item \code{document/docsource/metrics/report_inputs/uuv_v22_current_focus_metrics.json}
  \item \code{document/docsource/metrics/report_inputs/measurement_current_mode_path_latest_v30.json}
  \item \code{document/docsource/metrics/report_inputs/measurement_summary_current_heavefix_latest_v30.json}
