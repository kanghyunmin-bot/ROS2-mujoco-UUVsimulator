...
cd /workspace/rospkg
KMU26_BUILD_JOBS=2 ./build_safe.sh --packages-up-to kmu26_auv_vla_policy auv_mavros_dvl_plugin dvl_msgs hit25_auv_ros2 hit25_auv_ros2_msg --cmake-args -DBUILD_TESTING=OFF
