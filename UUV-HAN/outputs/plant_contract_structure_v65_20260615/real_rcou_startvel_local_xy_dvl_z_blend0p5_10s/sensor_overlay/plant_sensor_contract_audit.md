...
- sim_csv: `/Users/kanghyunmin/Desktop/uuv_sim/UUV-HAN/outputs/plant_contract_structure_v65_20260615/real_rcou_startvel_local_xy_dvl_z_blend0p5_10s/sim_sensor_replay.csv`
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| dvl_twist | 0.020 | 0.150 | 0.379 | 0.037 | 0.080 | `False` | `True` |
...
- yaw_delta_deg real/sim/ratio: `-181.870` / `-173.153` / `0.952`
- gyro_z_integral_deg real/sim/ratio: `-181.762` / `-172.999` / `0.952`

### Windowed Yaw Drift

| window_s | real_mean_r | sim_mean_r | mean_err_r | real_int_deg | sim_int_deg | deficit_deg | ratio |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0.00-10.00 | -0.3159 | -0.3018 | 0.0141 | -181.8 | -173.0 | 8.8 | 0.952 |

## Thruster Debug

- available: `True`; active_rows: `212`
- thr_torque_body_z mean/rms/min/max Nm: `-2.135` / `3.221` / `-9.566` / `0.832`
- ang_vel_body_z mean/rms/min/max rad/s: `-0.310` / `0.436` / `-0.975` / `0.132`
...
| --- | ---: | ---: | ---: | ---: |
| baro_ddepth_m | 0.013 | -0.005 | -0.007 | -2.950 |
| depth_pose_m | 0.013 | -0.002 | -0.007 | -2.950 |
| imu_roll_deg | 0.357 | 0.331 | 0.238 | 0.200 |
| imu_pitch_deg | 0.863 | -0.179 | -0.557 | 3.450 |
| imu_yaw_rel_deg | 23.666 | 0.987 | 20.502 | 0.200 |
| dvl_x_mps | 0.055 | -0.012 | -0.033 | 2.800 |
| dvl_y_mps | 0.056 | 0.134 | 0.031 | 1.450 |
| dvl_z_mps | 0.023 | 0.181 | 0.020 | 3.000 |
| gyro_x_radps | 0.018 | 0.511 | -0.001 | -4.450 |
| gyro_y_radps | 0.039 | -0.040 | -0.005 | 4.650 |
| gyro_z_radps | 0.251 | 0.740 | 0.014 | -4.400 |
| accel_x_mps2 | 0.163 | 0.147 | -0.060 | -4.350 |
| accel_y_mps2 | 0.269 | 0.552 | 0.207 | -0.250 |
| accel_z_mps2 | 0.057 | 0.029 | 0.019 | 3.200 |
...
| signal | RMSE | corr | bias | lag_s |
| --- | ---: | ---: | ---: | ---: |
| local_depth_m | 0.010 | -0.101 | -0.007 | -2.000 |
| local_x_m | 0.115 | 0.996 | -0.097 | 0.150 |
| local_y_m | 0.250 | 0.797 | 0.119 | 0.800 |
| local_vel_x_mps | 0.047 | 0.914 | 0.002 | 0.450 |
| local_vel_y_mps | 0.093 | 0.972 | 0.060 | 0.150 |
| local_vel_z_mps | 0.013 | 0.007 | -0.010 | -3.550 |
...
| sim | x | -0.042 | 0.074 | -0.249 | 0.205 |
| sim | y | -0.102 | 0.154 | -0.400 | 0.187 |
| sim | z | -0.848 | 0.848 | -0.963 | -0.614 |
...
| sim_local_surface | x | 0.952 | 0.014 | 0.987 |
| sim_local_surface | y | -0.988 | 0.001 | -0.971 |
| sim_local_surface | z | -0.667 | -0.004 | -0.800 |
| sim_truth_odom | x | 1.004 | -0.001 | 0.988 |
| sim_truth_odom | y | 0.991 | -0.000 | 0.993 |
| sim_truth_odom | z | 1.035 | -0.000 | 0.926 |
...
| sim_local_surface | -0.0019 | 0.0008 | 0.0583 | 0.0040 | 0.0039 | 0.034 |
| sim_truth_odom | 0.0001 | -0.0003 | -0.0087 | 0.0029 | 0.0029 | 0.002 |

## Axis Audit

- dvl_twist: identity_rank=`7`, identity_rmse_rank=`1`, best=`real_x <= -sim_y, real_y <= -sim_x, real_z <= +sim_z`, sumcorr=`0.501`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.134`
- imu_gyro: identity_rank=`2`, identity_rmse_rank=`2`, best=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, sumcorr=`1.291`, best_rmse=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, rmse_sum=`0.306`
- imu_accel: identity_rank=`1`, identity_rmse_rank=`1`, best=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, sumcorr=`0.728`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.489`
