...
- sim_csv: `/Users/kanghyunmin/Desktop/uuv_sim/UUV-HAN/outputs/plant_contract_structure_v65_20260615/real_rcou_startvel_local_xy_dvl_z_buoy1014_10s/sim_sensor_replay.csv`
...
| --- | --- | ---: | --- |
| bar30_depth | baro_ddepth_m | -0.148 | `False` |
| dvl_vel_x | dvl_x_mps | -0.008 | `False` |
| dvl_vel_y | dvl_y_mps | 0.135 | `False` |
| dvl_vel_z | dvl_z_mps | 0.141 | `False` |
| imu_roll | imu_roll_deg | 0.315 | `False` |
...
- yaw_delta_deg real/sim/ratio: `-181.870` / `-173.304` / `0.953`
- gyro_z_integral_deg real/sim/ratio: `-181.762` / `-173.126` / `0.952`

### Windowed Yaw Drift

| window_s | real_mean_r | sim_mean_r | mean_err_r | real_int_deg | sim_int_deg | deficit_deg | ratio |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0.00-10.00 | -0.3159 | -0.3020 | 0.0139 | -181.8 | -173.1 | 8.6 | 0.952 |

## Thruster Debug

- available: `True`; active_rows: `211`
- thr_torque_body_z mean/rms/min/max Nm: `-2.140` / `3.217` / `-9.343` / `0.820`
- ang_vel_body_z mean/rms/min/max rad/s: `-0.311` / `0.437` / `-0.981` / `0.130`
...
| --- | ---: | ---: | ---: | ---: |
| baro_ddepth_m | 0.016 | -0.148 | 0.006 | -4.500 |
| depth_pose_m | 0.016 | -0.149 | 0.007 | -4.500 |
| imu_roll_deg | 0.363 | 0.315 | 0.245 | 0.200 |
| imu_pitch_deg | 0.867 | -0.177 | -0.562 | 3.450 |
| imu_yaw_rel_deg | 23.555 | 0.988 | 20.452 | 0.200 |
| dvl_x_mps | 0.055 | -0.008 | -0.032 | 2.800 |
| dvl_y_mps | 0.056 | 0.135 | 0.031 | 1.450 |
| dvl_z_mps | 0.026 | 0.141 | 0.023 | 3.000 |
| gyro_x_radps | 0.018 | 0.512 | -0.001 | -4.450 |
| gyro_y_radps | 0.040 | -0.039 | -0.005 | 4.650 |
| gyro_z_radps | 0.250 | 0.741 | 0.014 | -4.400 |
| accel_x_mps2 | 0.163 | 0.145 | -0.059 | -4.350 |
| accel_y_mps2 | 0.271 | 0.537 | 0.208 | -0.300 |
| accel_z_mps2 | 0.066 | 0.029 | 0.020 | 3.150 |
...
| signal | RMSE | corr | bias | lag_s |
| --- | ---: | ---: | ---: | ---: |
| local_depth_m | 0.013 | -0.159 | 0.006 | 5.000 |
| local_x_m | 0.115 | 0.996 | -0.098 | 0.150 |
| local_y_m | 0.252 | 0.798 | 0.124 | 0.800 |
| local_vel_x_mps | 0.046 | 0.915 | 0.001 | 0.450 |
| local_vel_y_mps | 0.093 | 0.972 | 0.061 | 0.150 |
| local_vel_z_mps | 0.017 | 0.066 | -0.014 | 2.850 |
...
| sim | x | -0.041 | 0.075 | -0.249 | 0.232 |
| sim | y | -0.102 | 0.156 | -0.410 | 0.212 |
| sim | z | -0.846 | 0.847 | -0.967 | -0.470 |
...
| sim_local_surface | z | -0.454 | -0.005 | -0.683 |
| sim_truth_odom | x | 1.002 | -0.000 | 0.988 |
| sim_truth_odom | y | 0.991 | -0.000 | 0.993 |
| sim_truth_odom | z | 1.292 | -0.003 | 0.844 |
...
| sim_local_surface | -0.0014 | 0.0008 | 0.0503 | 0.0047 | 0.0046 | 0.020 |
| sim_truth_odom | -0.0002 | -0.0002 | -0.0038 | 0.0033 | 0.0032 | 0.001 |

## Axis Audit

- dvl_twist: identity_rank=`7`, identity_rmse_rank=`2`, best=`real_x <= -sim_y, real_y <= +sim_z, real_z <= -sim_x`, sumcorr=`0.520`, best_rmse=`real_x <= +sim_x, real_y <= -sim_z, real_z <= -sim_y`, rmse_sum=`0.135`
- imu_gyro: identity_rank=`2`, identity_rmse_rank=`2`, best=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, sumcorr=`1.293`, best_rmse=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, rmse_sum=`0.306`
- imu_accel: identity_rank=`1`, identity_rmse_rank=`1`, best=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, sumcorr=`0.711`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.500`
