...
- sim_csv: `/Users/kanghyunmin/Desktop/uuv_sim/UUV-HAN/outputs/plant_contract_structure_v65_20260615/real_rcou_startvel_dvl_10s/sim_sensor_replay.csv`
...
| --- | --- | ---: | --- |
| bar30_depth | baro_ddepth_m | 0.002 | `False` |
| dvl_vel_x | dvl_x_mps | 0.001 | `False` |
| dvl_vel_y | dvl_y_mps | 0.070 | `False` |
| dvl_vel_z | dvl_z_mps | 0.136 | `False` |
| imu_roll | imu_roll_deg | 0.330 | `False` |
| imu_pitch | imu_pitch_deg | -0.178 | `False` |
| imu_yaw_delta | imu_yaw_rel_deg | 0.987 | `True` |
| imu_gyro_x | gyro_x_radps | 0.505 | `False` |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| dvl_twist | 0.020 | 0.150 | 0.379 | 0.118 | 0.080 | `False` | `False` |
...
| depth_pose | 2.000 | 2.000 | 1.000 | 19 | 22 |
...
| depth_pose | 0.000 | 0.020 | 0.020 | 0.857 | 0.952 |
...
- yaw_delta_deg real/sim/ratio: `-181.870` / `-171.959` / `0.946`
- gyro_z_integral_deg real/sim/ratio: `-181.762` / `-171.793` / `0.945`

### Windowed Yaw Drift

| window_s | real_mean_r | sim_mean_r | mean_err_r | real_int_deg | sim_int_deg | deficit_deg | ratio |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0.00-10.00 | -0.3159 | -0.2997 | 0.0162 | -181.8 | -171.8 | 10.0 | 0.945 |

## Thruster Debug

- available: `True`; active_rows: `214`
- thr_torque_body_z mean/rms/min/max Nm: `-2.119` / `3.210` / `-9.587` / `0.846`
- ang_vel_body_z mean/rms/min/max rad/s: `-0.308` / `0.435` / `-0.979` / `0.135`
...
| --- | ---: | ---: | ---: | ---: |
| baro_ddepth_m | 0.013 | 0.002 | -0.006 | -2.950 |
| depth_pose_m | 0.013 | 0.006 | -0.006 | -3.000 |
| imu_roll_deg | 0.357 | 0.330 | 0.238 | 0.250 |
| imu_pitch_deg | 0.864 | -0.178 | -0.558 | 3.450 |
| imu_yaw_rel_deg | 24.541 | 0.987 | 21.288 | 0.200 |
| dvl_x_mps | 0.055 | 0.001 | -0.033 | 2.800 |
| dvl_y_mps | 0.057 | 0.070 | 0.029 | 1.450 |
| dvl_z_mps | 0.024 | 0.136 | 0.021 | 3.000 |
| gyro_x_radps | 0.018 | 0.505 | -0.001 | -4.450 |
| gyro_y_radps | 0.040 | -0.039 | -0.005 | 4.650 |
| gyro_z_radps | 0.251 | 0.739 | 0.016 | -4.400 |
| accel_x_mps2 | 0.164 | 0.148 | -0.061 | -4.350 |
| accel_y_mps2 | 0.267 | 0.508 | 0.199 | -0.250 |
| accel_z_mps2 | 0.066 | 0.029 | 0.021 | 3.200 |
...
| signal | RMSE | corr | bias | lag_s |
| --- | ---: | ---: | ---: | ---: |
| local_depth_m | 0.009 | -0.097 | -0.007 | -2.000 |
| local_x_m | 0.122 | 0.996 | -0.105 | 0.150 |
| local_y_m | 0.267 | 0.775 | 0.133 | 0.850 |
| local_vel_x_mps | 0.051 | 0.898 | 0.000 | 0.450 |
| local_vel_y_mps | 0.097 | 0.970 | 0.065 | 0.150 |
| local_vel_z_mps | 0.015 | 0.074 | -0.011 | 3.050 |
...
| sim | x | -0.043 | 0.076 | -0.251 | 0.206 |
| sim | y | -0.110 | 0.157 | -0.401 | 0.046 |
| sim | z | -0.846 | 0.847 | -0.969 | -0.458 |
...
| sim_local_surface | x | 0.919 | 0.023 | 0.977 |
| sim_local_surface | y | -0.862 | 0.008 | -0.979 |
| sim_local_surface | z | -0.428 | -0.006 | -0.655 |
| sim_truth_odom | x | 1.011 | -0.002 | 0.981 |
| sim_truth_odom | y | 1.075 | 0.005 | 0.995 |
| sim_truth_odom | z | 1.318 | -0.004 | 0.815 |
...
| sim_local_surface | -0.0021 | 0.0008 | 0.0781 | 0.0061 | 0.0059 | 0.028 |
| sim_truth_odom | -0.0008 | -0.0002 | 0.0095 | 0.0041 | 0.0041 | 0.001 |

## Axis Audit

- dvl_twist: identity_rank=`7`, identity_rmse_rank=`1`, best=`real_x <= -sim_y, real_y <= +sim_z, real_z <= -sim_x`, sumcorr=`0.541`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.136`
- imu_gyro: identity_rank=`2`, identity_rmse_rank=`2`, best=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, sumcorr=`1.284`, best_rmse=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, rmse_sum=`0.308`
- imu_accel: identity_rank=`1`, identity_rmse_rank=`1`, best=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, sumcorr=`0.685`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.498`
