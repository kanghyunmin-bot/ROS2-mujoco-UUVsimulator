...
- sim_csv: `/Users/kanghyunmin/Desktop/uuv_sim/UUV-HAN/outputs/plant_contract_structure_v65_20260615/highrate_recon_vertical_gain_0p25_10s/sim_sensor_replay.csv`
- window: `0.350s -> 10.350s`

## Plant Input

- samples: `4008`; mismatches: `0`; maxdiff_us: `0.000`; ok: `True`
- input source window used by sim rows: `0.800s -> 10.799s`; before_first: `0`; after_last: `0`
- raw sample median_dt: `0.001s`; raw median_hz: `1200.480`
- distinct PWM steps: `3141`; step median_dt: `0.002s`; step median_hz: `400.000`; zoh_resampled_telemetry_like: `False`
...
- available: `True`; samples: `501`; mismatches: `500`; maxdiff_us: `205.000`; ok: `True`
...
- step latency median/p95/max: `0.012` / `0.022` / `0.042` s; low_latency_ok: `False`; assessment: `unobservable_high_rate_input_vs_thruster_debug_sampling`
- sampled runtime: available=`True`; ok=`True`; nominal_p95_us=`26.050`; best_phase_s=`-0.013`; best_p95_us=`10.000`
...
| --- | --- | ---: | --- |
| bar30_depth | baro_ddepth_m | 0.154 | `False` |
| dvl_vel_x | dvl_x_mps | -0.338 | `False` |
| dvl_vel_y | dvl_y_mps | 0.175 | `False` |
| dvl_vel_z | dvl_z_mps | -0.031 | `False` |
| imu_roll | imu_roll_deg | 0.258 | `False` |
| imu_pitch | imu_pitch_deg | -0.310 | `False` |
| imu_yaw_delta | imu_yaw_rel_deg | 0.937 | `True` |
| imu_gyro_x | gyro_x_radps | 0.559 | `False` |
| imu_gyro_y | gyro_y_radps | 0.004 | `False` |
| imu_gyro_z | gyro_z_radps | 0.796 | `False` |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| dvl_twist | 0.020 | 0.150 | 0.379 | 0.024 | 0.080 | `False` | `True` |
...
| depth_pose | 0.001 | 0.002 | 0.000 | 0.006 | 0.006 |
| imu_data | 0.002 | 0.002 | -0.000 | 0.061 | 0.061 |
| imu_raw | nan | 0.001 | nan | nan | 0.006 |
| dvl_twist | 0.002 | 0.002 | 0.000 | 0.038 | 0.030 |
| local_pose | 0.001 | 0.001 | 0.000 | 0.009 | 0.009 |
| local_vel_body | nan | 0.001 | nan | nan | 0.009 |

## Yaw Motion

- yaw_delta_deg real/sim/ratio: `-181.870` / `-158.281` / `0.870`
- gyro_z_integral_deg real/sim/ratio: `-181.762` / `-158.201` / `0.870`

### Windowed Yaw Drift

| window_s | real_mean_r | sim_mean_r | mean_err_r | real_int_deg | sim_int_deg | deficit_deg | ratio |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0.00-10.00 | -0.3159 | -0.2745 | 0.0414 | -181.8 | -158.2 | 23.6 | 0.870 |

## Thruster Debug

- available: `True`; active_rows: `235`
- thr_torque_body_z mean/rms/min/max Nm: `-1.524` / `4.039` / `-10.498` / `3.133`
- ang_vel_body_z mean/rms/min/max rad/s: `-0.187` / `0.501` / `-1.085` / `0.444`
...
| --- | ---: | ---: | ---: | ---: |
| baro_ddepth_m | 0.026 | 0.154 | -0.021 | 4.050 |
| depth_pose_m | 0.026 | 0.159 | -0.021 | 4.000 |
| imu_roll_deg | 0.418 | 0.258 | 0.186 | -0.050 |
| imu_pitch_deg | 1.565 | -0.310 | -1.157 | 3.200 |
| imu_yaw_rel_deg | 25.918 | 0.937 | -15.879 | -0.050 |
| dvl_x_mps | 0.099 | -0.338 | -0.067 | -4.300 |
| dvl_y_mps | 0.057 | 0.175 | 0.032 | -0.800 |
| dvl_z_mps | 0.024 | -0.031 | 0.020 | 3.300 |
| gyro_x_radps | 0.019 | 0.559 | -0.003 | -4.600 |
| gyro_y_radps | 0.068 | 0.004 | -0.005 | -3.250 |
| gyro_z_radps | 0.274 | 0.796 | 0.041 | -0.150 |
| accel_x_mps2 | 0.322 | -0.014 | 0.038 | 5.000 |
| accel_y_mps2 | 0.332 | 0.235 | 0.217 | 4.750 |
| accel_z_mps2 | 0.066 | 0.048 | 0.018 | 3.850 |
...
| signal | RMSE | corr | bias | lag_s |
| --- | ---: | ---: | ---: | ---: |
| local_depth_m | 0.026 | 0.072 | -0.023 | 3.500 |
| local_x_m | 0.452 | 0.984 | -0.350 | -0.200 |
| local_y_m | 0.940 | 0.613 | -0.843 | -1.550 |
| local_vel_x_mps | 0.113 | 0.693 | -0.076 | -0.200 |
| local_vel_y_mps | 0.150 | 0.924 | -0.108 | -0.500 |
| local_vel_z_mps | 0.010 | -0.113 | -0.006 | 3.150 |
...
| sim | x | -0.046 | 0.217 | -1.792 | 0.379 |
| sim | y | -0.083 | 0.179 | -0.406 | 0.193 |
| sim | z | -0.851 | 0.852 | -1.085 | -0.640 |
...
| sim | x | 200 | 0.003 | 0.983 | -0.000 |
| sim | y | 200 | 0.014 | 0.975 | -0.001 |
| sim | z | 200 | 0.021 | 0.999 | -0.000 |
...
| sim_local_surface | x | 0.831 | 0.043 | 0.849 |
| sim_local_surface | y | -0.997 | 0.000 | -0.983 |
| sim_local_surface | z | -0.678 | -0.003 | -0.717 |
| sim_truth_odom | x | 0.976 | 0.007 | 0.962 |
| sim_truth_odom | y | 0.992 | -0.000 | 0.996 |
| sim_truth_odom | z | 0.973 | 0.000 | 0.945 |
...
| sim_local_surface | -0.0111 | 0.0011 | 0.3234 | 0.0176 | 0.0129 | 0.267 |
| sim_truth_odom | 0.0037 | -0.0013 | -0.1156 | 0.0086 | 0.0075 | 0.134 |

## Axis Audit

- dvl_twist: identity_rank=`34`, identity_rmse_rank=`1`, best=`real_x <= -sim_y, real_y <= -sim_x, real_z <= -sim_z`, sumcorr=`0.619`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.179`
- imu_gyro: identity_rank=`1`, identity_rmse_rank=`1`, best=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, sumcorr=`1.359`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.361`
- imu_accel: identity_rank=`6`, identity_rmse_rank=`1`, best=`real_x <= -sim_z, real_y <= +sim_x, real_z <= -sim_y`, sumcorr=`0.386`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.720`
