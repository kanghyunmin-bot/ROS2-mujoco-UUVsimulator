...
- sim_csv: `/Users/kanghyunmin/Desktop/uuv_sim/UUV-HAN/outputs/plant_contract_structure_v65_20260615/real_rcou_geometry_bar30_10s/sim_sensor_replay.csv`
...
| dvl_vel_z | dvl_z_mps | 0.144 | `False` |
| imu_roll | imu_roll_deg | 0.332 | `False` |
| imu_pitch | imu_pitch_deg | -0.179 | `False` |
| imu_yaw_delta | imu_yaw_rel_deg | 0.987 | `True` |
| imu_gyro_x | gyro_x_radps | 0.513 | `False` |
| imu_gyro_y | gyro_y_radps | -0.042 | `False` |
| imu_gyro_z | gyro_z_radps | 0.738 | `False` |
...
- yaw_delta_deg real/sim/ratio: `-181.870` / `-172.061` / `0.946`
- gyro_z_integral_deg real/sim/ratio: `-181.762` / `-171.922` / `0.946`

### Windowed Yaw Drift

| window_s | real_mean_r | sim_mean_r | mean_err_r | real_int_deg | sim_int_deg | deficit_deg | ratio |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0.00-10.00 | -0.3159 | -0.2999 | 0.0160 | -181.8 | -171.9 | 9.8 | 0.946 |

## Thruster Debug

- available: `True`; active_rows: `214`
- thr_torque_body_z mean/rms/min/max Nm: `-2.117` / `3.208` / `-9.570` / `0.845`
- ang_vel_body_z mean/rms/min/max rad/s: `-0.308` / `0.434` / `-0.981` / `0.135`
...
| --- | ---: | ---: | ---: | ---: |
| baro_ddepth_m | 0.014 | -0.006 | -0.008 | -2.950 |
| depth_pose_m | 0.014 | -0.006 | -0.008 | -2.950 |
| imu_roll_deg | 0.357 | 0.332 | 0.239 | 0.200 |
| imu_pitch_deg | 0.862 | -0.179 | -0.557 | 3.450 |
| imu_yaw_rel_deg | 24.511 | 0.987 | 21.232 | 0.200 |
| dvl_x_mps | 0.055 | -0.012 | -0.033 | 2.800 |
| dvl_y_mps | 0.056 | 0.133 | 0.031 | 1.450 |
| dvl_z_mps | 0.023 | 0.144 | 0.020 | -4.050 |
| gyro_x_radps | 0.018 | 0.513 | -0.001 | -4.450 |
| gyro_y_radps | 0.039 | -0.042 | -0.005 | 4.650 |
| gyro_z_radps | 0.252 | 0.738 | 0.016 | -4.400 |
| accel_x_mps2 | 0.163 | 0.152 | -0.060 | -4.350 |
| accel_y_mps2 | 0.269 | 0.557 | 0.208 | -0.250 |
| accel_z_mps2 | 0.052 | 0.024 | 0.017 | 3.200 |
...
| signal | RMSE | corr | bias | lag_s |
| --- | ---: | ---: | ---: | ---: |
| local_depth_m | 0.011 | -0.101 | -0.009 | -3.200 |
| local_x_m | 0.113 | 0.996 | -0.094 | 0.150 |
| local_y_m | 0.264 | 0.775 | 0.128 | 0.850 |
| local_vel_x_mps | 0.048 | 0.908 | 0.003 | 0.450 |
| local_vel_y_mps | 0.097 | 0.970 | 0.063 | 0.150 |
| local_vel_z_mps | 0.012 | -0.174 | -0.010 | -3.850 |
...
| sim | x | -0.041 | 0.075 | -0.251 | 0.214 |
| sim | y | -0.101 | 0.153 | -0.401 | 0.173 |
| sim | z | -0.850 | 0.850 | -0.963 | -0.756 |
...
- sim gyro self-axis: identity_corr_rank=`1`, identity_rmse_rank=`1`, identity_rmse_sum=`0.025`, best_rmse_sum=`0.025`, best_rmse_mapping=`['real_x <= +sim_x', 'real_y <= +sim_y', 'real_z <= +sim_z']`
...
| sim_local_surface | x | 0.950 | 0.014 | 0.986 |
| sim_local_surface | y | -0.988 | 0.001 | -0.971 |
| sim_local_surface | z | -0.754 | -0.003 | -0.872 |
| sim_truth_odom | x | 1.003 | -0.000 | 0.987 |
| sim_truth_odom | y | 0.991 | -0.000 | 0.993 |
| sim_truth_odom | z | 1.028 | -0.000 | 0.952 |
...
| sim_local_surface | -0.0026 | 0.0008 | 0.0665 | 0.0040 | 0.0039 | 0.043 |
| sim_truth_odom | 0.0001 | -0.0003 | -0.0076 | 0.0030 | 0.0030 | 0.001 |

## Axis Audit

- dvl_twist: identity_rank=`8`, identity_rmse_rank=`1`, best=`real_x <= -sim_y, real_y <= -sim_z, real_z <= -sim_x`, sumcorr=`0.521`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.134`
- imu_gyro: identity_rank=`2`, identity_rmse_rank=`2`, best=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, sumcorr=`1.293`, best_rmse=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, rmse_sum=`0.307`
- imu_accel: identity_rank=`1`, identity_rmse_rank=`1`, best=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, sumcorr=`0.732`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.483`
