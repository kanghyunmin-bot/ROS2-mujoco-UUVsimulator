...
- sim_csv: `/Users/kanghyunmin/Desktop/uuv_sim/UUV-HAN/outputs/plant_contract_structure_v65_20260615/real_rcou_startvel_local_xy_dvl_z_buoy100_10s/sim_sensor_replay.csv`
...
| --- | --- | ---: | --- |
| bar30_depth | baro_ddepth_m | -0.163 | `False` |
| dvl_vel_x | dvl_x_mps | -0.002 | `False` |
| dvl_vel_y | dvl_y_mps | 0.141 | `False` |
| dvl_vel_z | dvl_z_mps | 0.145 | `False` |
| imu_roll | imu_roll_deg | 0.275 | `False` |
| imu_pitch | imu_pitch_deg | -0.176 | `False` |
| imu_yaw_delta | imu_yaw_rel_deg | 0.988 | `True` |
| imu_gyro_x | gyro_x_radps | 0.515 | `False` |
| imu_gyro_y | gyro_y_radps | -0.042 | `False` |
| imu_gyro_z | gyro_z_radps | 0.741 | `False` |
...
- yaw_delta_deg real/sim/ratio: `-181.870` / `-173.483` / `0.954`
- gyro_z_integral_deg real/sim/ratio: `-181.762` / `-173.300` / `0.953`

### Windowed Yaw Drift

| window_s | real_mean_r | sim_mean_r | mean_err_r | real_int_deg | sim_int_deg | deficit_deg | ratio |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0.00-10.00 | -0.3159 | -0.3023 | 0.0136 | -181.8 | -173.3 | 8.5 | 0.953 |

## Thruster Debug

- available: `True`; active_rows: `211`
- thr_torque_body_z mean/rms/min/max Nm: `-2.145` / `3.229` / `-9.367` / `0.828`
- ang_vel_body_z mean/rms/min/max rad/s: `-0.312` / `0.439` / `-0.983` / `0.132`
...
| --- | ---: | ---: | ---: | ---: |
| baro_ddepth_m | 0.046 | -0.163 | 0.035 | -4.500 |
| depth_pose_m | 0.046 | -0.163 | 0.035 | -4.500 |
| imu_roll_deg | 0.379 | 0.275 | 0.261 | 0.200 |
| imu_pitch_deg | 0.875 | -0.176 | -0.570 | 3.450 |
| imu_yaw_rel_deg | 23.658 | 0.988 | 20.572 | 0.200 |
| dvl_x_mps | 0.054 | -0.002 | -0.031 | 2.800 |
| dvl_y_mps | 0.056 | 0.141 | 0.031 | 1.450 |
| dvl_z_mps | 0.031 | 0.145 | 0.029 | 2.650 |
| gyro_x_radps | 0.018 | 0.515 | -0.001 | -4.450 |
| gyro_y_radps | 0.040 | -0.042 | -0.005 | 4.650 |
| gyro_z_radps | 0.251 | 0.741 | 0.014 | -4.400 |
| accel_x_mps2 | 0.166 | 0.136 | -0.057 | -4.350 |
| accel_y_mps2 | 0.273 | 0.533 | 0.210 | -0.300 |
| accel_z_mps2 | 0.063 | 0.026 | 0.020 | 3.200 |
...
| signal | RMSE | corr | bias | lag_s |
| --- | ---: | ---: | ---: | ---: |
| local_depth_m | 0.045 | -0.157 | 0.035 | -4.600 |
| local_x_m | 0.113 | 0.996 | -0.096 | 0.150 |
| local_y_m | 0.260 | 0.793 | 0.134 | 0.800 |
| local_vel_x_mps | 0.047 | 0.914 | 0.002 | 0.450 |
| local_vel_y_mps | 0.093 | 0.972 | 0.062 | 0.150 |
| local_vel_z_mps | 0.022 | 0.040 | -0.020 | 2.800 |
...
| sim | x | -0.041 | 0.078 | -0.248 | 0.287 |
| sim | y | -0.103 | 0.157 | -0.409 | 0.222 |
| sim | z | -0.846 | 0.848 | -0.969 | -0.516 |
...
| sim_local_surface | x | 0.954 | 0.013 | 0.989 |
| sim_local_surface | y | -0.989 | 0.001 | -0.972 |
| sim_local_surface | z | -0.515 | -0.001 | -0.727 |
| sim_truth_odom | x | 1.000 | 0.000 | 0.988 |
| sim_truth_odom | y | 0.991 | -0.000 | 0.993 |
| sim_truth_odom | z | 1.166 | -0.001 | 0.871 |
...
| sim_local_surface | -0.0014 | 0.0010 | 0.0483 | 0.0044 | 0.0043 | 0.021 |
| sim_truth_odom | -0.0005 | -0.0003 | 0.0034 | 0.0032 | 0.0032 | 0.001 |

## Axis Audit

- dvl_twist: identity_rank=`7`, identity_rmse_rank=`3`, best=`real_x <= -sim_y, real_y <= +sim_z, real_z <= -sim_x`, sumcorr=`0.489`, best_rmse=`real_x <= +sim_x, real_y <= -sim_z, real_z <= -sim_y`, rmse_sum=`0.137`
- imu_gyro: identity_rank=`2`, identity_rmse_rank=`2`, best=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, sumcorr=`1.297`, best_rmse=`real_x <= +sim_x, real_y <= -sim_y, real_z <= +sim_z`, rmse_sum=`0.307`
- imu_accel: identity_rank=`1`, identity_rmse_rank=`1`, best=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, sumcorr=`0.694`, best_rmse=`real_x <= +sim_x, real_y <= +sim_y, real_z <= +sim_z`, rmse_sum=`0.502`
