...
the native SITL/MuJoCo stack, runs the axis RC override live check, and then
...
from gui.sim_stack_reset_commands import reset_sim_stack_blocking  # noqa: E402
...
python3 sim/current/tools/axis_rc_override_check.py \\
...
def main() -> int:
    ...
    owner = _LiveGuiOwner(backend="native", env_overrides=env_overrides)
