...
def evaluate_runtime_identity(inputs: RuntimeIdentityInputs) -> dict[str, bool | str]:
    ...
    checks = {
        "version_mentions_current": inputs.runtime_version.get("active_runtime") == "sim/current",
        "version_mentions_backing": inputs.runtime_version.get("backing_directory") == "sim/current",
