...
def mavlink_telemetry_status(self) -> dict[str, object]:
    ...
    return build_mavlink_telemetry_status(
        ...
        json_servo_frame_count=getattr(self, "_sitl_json_latest_frame_count", None),
        json_servo_frame_rate_hz=getattr(self, "_sitl_json_latest_frame_rate_hz", None),
        json_servo_last_wall=float(getattr(self, "_sitl_client_last_wall", -1.0)),
        json_sensor_packets_sent=int(getattr(self, "_sitl_send_counter", 0)),
