"""ROS2 topic/service registry data."""
...
PUBLISHER_SPECS: tuple[PublisherSpec, ...] = (
    ...
    PublisherSpec("dvl_twist", "TwistWithCovarianceStamped", "/dvl/twist", 1),
    PublisherSpec("dvl_alt", "Range", "/dvl/altitude", 1),
    PublisherSpec("depth", "Float32", "/depth", 1),
    PublisherSpec("depth_pose", "PoseWithCovarianceStamped", "/depth/pose", 1),
    ...
    PublisherSpec("hydrophone_direction", "Vector3Stamped", "/mujoco/hydrophone/direction", 10),
    PublisherSpec("hydrophone_audio", "AudioData", "/audio", 10),
    PublisherSpec("hydrophone_audio_info", "AudioInfo", "/audio_info", 10),
    ...
    PublisherSpec("mavros_local_vel_body", "TwistStamped", "/mavros/local_position/velocity_body", 1),
    PublisherSpec("mavros_local_vel_body_cov", "TwistWithCovarianceStamped", "/mavros/local_position/velocity_body_cov", 1),
...
SUBSCRIBER_SPECS: tuple[SubscriberSpec, ...] = (
    ...
    SubscriberSpec("mavros_setpoint", "PositionTarget", "/mavros/setpoint_raw/local", "_on_mavros_setpoint", 1),
    SubscriberSpec("mavros_rc_override", "OverrideRCIn", "/mavros/rc/override", "_on_mavros_rc_override", 1),
    SubscriberSpec("mavros_manual_control", "ManualControl", "/mavros/manual_control/send", "_on_mavros_manual_control", 1),
)
