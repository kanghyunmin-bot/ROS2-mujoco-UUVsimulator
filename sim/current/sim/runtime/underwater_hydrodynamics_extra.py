...
def apply_empirical_pitch_lift_heave(
    ...
    *,
    ...
    if (
        ...
        forward_speed = float(rel_lin_vel_body[0])
        # The empirical coefficient is defined in the vehicle body frame.
        # Free-joint qvel storage is not a stable body-frame contract once the
        # vehicle is rolled or pitched; the caller already resolved omega.
