...
from . import node_init_publishers
...
def bind_commanding(cls: type) -> None:
    cls.suspend_rc_override_publisher = node_init_publishers.suspend_rc_override_publisher
    cls.restore_rc_override_publisher = node_init_publishers.restore_rc_override_publisher
...
def bind_telemetry_callbacks(cls: type) -> None:
    ...
    cls._on_filtered_odom = node_telemetry_callbacks._on_filtered_odom
    ...
    cls.set_stereo_camera_display_mode = node_stereo_camera.set_stereo_camera_display_mode
