...
def apply_command_endpoint_defaults(env: dict[str, str]) -> None:
    ...
    default_command_endpoint = f"tcp:127.0.0.1:{tcp_mav_port}"
...
def apply_native_stable_defaults(
    ...
    *,
    ...
    stable_dir = Path(env.get("ARDUPILOT_STABLE_DIR", str(workspace_dir / "sim/ardupilot")))
    installed_dir = workspace_dir / "sim" / "ardupilot"
