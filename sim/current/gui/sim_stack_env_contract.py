...
def build_gui_sim_stack_env(
    ...
    *,
    ...
    # Environment precedence is explicit user input > GUI control contract >
    # native defaults. Apply the native transport defaults first so the
    # control contract (for example SITL_USE_REAL_PARAM_FILE=1 for Bar30
    # ALT_HOLD) cannot be silently replaced afterwards.
    ...
    apply_command_endpoint_defaults(env)
