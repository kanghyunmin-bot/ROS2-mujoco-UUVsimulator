...
function pingerHomingPayload() {
  ...
  const homingMode = $("pingerHomingAlgorithm").value || "no_odom_phase";
  return {
    ...
    success_range_m: numericValue("pingerHomingSuccessRange", 1.05),
    ...
    stop_range_m: numericValue("pingerHomingSuccessRange", 1.05),
  };
}
...
function applyPingerHomingAlgorithmDefaults() {
  ...
  $("pingerHomingProbePwmDelta").value = "90";
  $("pingerHomingApproachPwmDelta").value = "200";
  $("pingerHomingApproachDuration").value = "40";
  setText(
    "pingerHomingNavigationStatus",
    "NO_ODOM_PHASE · dual-band FFT · continuous-forward ABBA · ALT_HOLD",
  );
}
