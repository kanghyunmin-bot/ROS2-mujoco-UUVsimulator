...
from sim.runtime.viewer_scene_primitives import (
    add_arrow_geom,
...
class ViewerSceneBuilder:
    ...
    def add_arrow_segment(self, start, end, rgba, thickness: float = 0.02) -> None:
        add_arrow_segment_geom(self.user_scn, self.mujoco, start, end, rgba, thickness)
