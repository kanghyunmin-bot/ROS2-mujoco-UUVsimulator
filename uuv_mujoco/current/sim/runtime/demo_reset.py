...
class DemoReset:
    ...
    def tick(self, *, is_paused, publish_ros):
        ...
        # Match the regular raw-PWM path: FCU sensor transport must continue
        # every physics tick, independently of ROS telemetry/render throttling.
        if publish_ros or getattr(self.step, "sitl_enabled", False):
