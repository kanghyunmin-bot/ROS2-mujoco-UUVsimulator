...
```text
python3 -m compileall -q uuv_mujoco/current/bridge/sitl_command_targets.py uuv_mujoco/current/bridge/sitl_command_links.py uuv_mujoco/current/bridge/sitl_vehicle_heartbeat.py uuv_mujoco/current/bridge/sitl_mavlink_peer.py uuv_mujoco/current/bridge/sitl_commanding.py
