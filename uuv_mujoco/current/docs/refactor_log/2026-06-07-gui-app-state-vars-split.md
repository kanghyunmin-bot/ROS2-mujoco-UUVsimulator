...
python3 -m compileall -q \
  uuv_mujoco/current/gui/app_state.py \
  uuv_mujoco/current/gui/app_state_vars.py \
  uuv_mujoco/current/gui/app_state_core_vars.py \
  uuv_mujoco/current/gui/app_state_feature_vars.py \
  uuv_mujoco/current/gui/app_state_tk_vars.py
