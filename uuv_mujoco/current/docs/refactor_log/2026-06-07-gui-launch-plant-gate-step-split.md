...
python3 -m compileall -q \
  uuv_mujoco/current/gui/sim_stack_launch_runtime.py \
  uuv_mujoco/current/gui/sim_stack_launch_command.py \
  uuv_mujoco/current/gui/sim_stack_launch_logs.py \
  uuv_mujoco/current/gui/sim_stack_launch_process.py \
  uuv_mujoco/current/gui/sim_stack_launch_target.py \
  uuv_mujoco/current/sim/validation/plant_input_gate.py \
  uuv_mujoco/current/sim/validation/plant_input_gate_*.py \
  uuv_mujoco/current/sim/runtime/simulation_step_runtime.py \
  uuv_mujoco/current/sim/runtime/simulation_step_physics.py \
  uuv_mujoco/current/sim/runtime/simulation_step_hold_release.py
```
