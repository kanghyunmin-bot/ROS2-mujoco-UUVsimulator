...
```text
env PYTHONPYCACHEPREFIX=/private/tmp/pycache python3 -m compileall -q uuv_mujoco/current/bridge uuv_mujoco/current/tools uuv_mujoco/current/gui
...
PY
env PYTHONPATH=/Users/kanghyunmin/Desktop/uuv_sim/uuv_mujoco/current PYTHONPYCACHEPREFIX=/private/tmp/pycache python3 - <<'PY'
...
env PYTHONPYCACHEPREFIX=/private/tmp/pycache python3 uuv_mujoco/current/tools/audit_code_contract_sources.py --out-dir /private/tmp/uuv_source_audit_refactor_batch_20260610
env PYTHONPYCACHEPREFIX=/private/tmp/pycache python3 uuv_mujoco/current/tools/refactor_inventory.py --root uuv_mujoco/current --format markdown --limit 20
```
