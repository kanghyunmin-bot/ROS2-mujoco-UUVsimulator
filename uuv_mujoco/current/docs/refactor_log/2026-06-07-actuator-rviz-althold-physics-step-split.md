...
python3 -m compileall -q \
  ...
  uuv_mujoco/current/tools/actuator_wrench_axis.py \
  uuv_mujoco/current/tools/actuator_wrench_summary.py \
  uuv_mujoco/current/gui/rviz_config_tools.py \
  uuv_mujoco/current/gui/rviz_config_ros2.py \
  uuv_mujoco/current/gui/rviz_config_ping360.py \
  uuv_mujoco/current/tools/analyze_althold_contract.py \
  uuv_mujoco/current/tools/althold_contract_signals.py \
  uuv_mujoco/current/tools/althold_contract_summary.py \
  uuv_mujoco/current/sim/runtime/physics_step_callbacks.py \
  uuv_mujoco/current/sim/runtime/physics_step_debug.py \
  uuv_mujoco/current/sim/runtime/physics_step_descent.py
```
