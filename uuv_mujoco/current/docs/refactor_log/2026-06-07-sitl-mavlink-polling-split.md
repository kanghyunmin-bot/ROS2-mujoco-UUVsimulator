...
```text
python3 -m compileall -q uuv_mujoco/current/bridge/sitl_mavlink_polling.py uuv_mujoco/current/bridge/sitl_mavlink_servo_handlers.py uuv_mujoco/current/bridge/sitl_mavlink_servo_polling.py uuv_mujoco/current/bridge/sitl_mavlink_command_polling.py
