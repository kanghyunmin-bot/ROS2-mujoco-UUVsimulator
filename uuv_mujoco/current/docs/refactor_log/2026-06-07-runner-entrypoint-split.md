...
Scope: active MuJoCo runner under `uuv_mujoco/current/run_uuv_mujoco.py`.
...
python3 -m py_compile \
  uuv_mujoco/current/run_uuv_mujoco.py \
  uuv_mujoco/current/sim/runtime/runner_profile_setup.py \
  uuv_mujoco/current/sim/runtime/runner_initial_setup.py \
  uuv_mujoco/current/sim/runtime/runner_physics_setup.py \
  uuv_mujoco/current/sim/runtime/runner_step_setup.py \
  uuv_mujoco/current/sim/runtime/runner_loop_setup.py
source ./.uuv_mujoco_env.sh && "$MJ311_PYTHON" uuv_mujoco/current/run_uuv_mujoco.py --help
source ./.uuv_mujoco_env.sh && "$MJ311_PYTHON" uuv_mujoco/current/run_uuv_mujoco.py --list-profiles
source ./.uuv_mujoco_env.sh && PYTHONPATH=uuv_mujoco/current/tools \
  ...
  --simulate-s 0
python3 uuv_mujoco/current/tools/refactor_inventory.py --root uuv_mujoco/current --limit 40
```
