...
python3 -m compileall -q \
  uuv_mujoco/current/sim/runtime/readiness.py \
  uuv_mujoco/current/sim/runtime/readiness_types.py \
  uuv_mujoco/current/sim/runtime/readiness_label.py \
  uuv_mujoco/current/gui/node_readiness_runtime.py \
  uuv_mujoco/current/tools/check_runtime_readiness_policy.py
