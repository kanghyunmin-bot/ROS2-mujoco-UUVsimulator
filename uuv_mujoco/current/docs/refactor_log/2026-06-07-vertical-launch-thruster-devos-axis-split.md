...
`uuv_mujoco/current` while preserving Bar30/SITL contracts, GUI launch
...
PYTHONPATH=uuv_mujoco/current python3 <thruster_params.json loader smoke>
PYTHONPATH=uuv_mujoco/current/tools python3 <axis RC metrics smoke>
