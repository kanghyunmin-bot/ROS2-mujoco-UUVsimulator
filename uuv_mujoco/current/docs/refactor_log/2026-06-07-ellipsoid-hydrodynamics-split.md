...
python3 -m compileall -q \
  ...
  uuv_mujoco/current/physics/ellipsoid_geometry.py \
  uuv_mujoco/current/physics/ellipsoid_hydro_coefficients.py \
  uuv_mujoco/current/physics/ellipsoid_hydro_types.py \
  uuv_mujoco/current/physics/hydrodynamics_helpers.py \
