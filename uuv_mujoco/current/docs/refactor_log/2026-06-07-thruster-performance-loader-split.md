...
python3 -m compileall -q \
  uuv_mujoco/current/sim/physics/thruster_performance_loader.py \
  uuv_mujoco/current/sim/physics/thruster_performance_payload.py \
  uuv_mujoco/current/sim/physics/thruster_performance_curves.py \
  uuv_mujoco/current/sim/physics/thruster_performance.py \
  uuv_mujoco/current/sim/physics/thruster_performance_selector.py
