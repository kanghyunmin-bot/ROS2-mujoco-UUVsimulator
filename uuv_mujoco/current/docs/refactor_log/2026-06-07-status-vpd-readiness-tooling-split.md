...
Scope: active runtime `uuv_mujoco/current`, backed by `uuv_mujoco/v2.2`.
...
python3 uuv_mujoco/current/tools/refactor_inventory.py --root uuv_mujoco/current --format markdown --limit 25
```
