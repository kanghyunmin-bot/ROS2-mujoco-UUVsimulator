...
python3 -m py_compile \
  ...
  uuv_mujoco/current/gui/node_vehicle_callbacks.py \
  uuv_mujoco/current/gui/node_motion_callbacks.py \
  uuv_mujoco/current/gui/node_rc_callbacks.py \
  uuv_mujoco/current/gui/node_sitl_status_callbacks.py \
  uuv_mujoco/current/gui/node_ping360_callbacks.py \
...
git diff --check
python3 uuv_mujoco/current/tools/refactor_inventory.py --limit 25
```
