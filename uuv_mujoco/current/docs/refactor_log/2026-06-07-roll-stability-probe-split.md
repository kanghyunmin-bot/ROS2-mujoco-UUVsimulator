...
```text
python3 -m compileall -q uuv_mujoco/current/tools/roll_stability_probe.py uuv_mujoco/current/tools/roll_stability_probe_callbacks.py uuv_mujoco/current/tools/roll_stability_probe_rc.py uuv_mujoco/current/tools/roll_stability_probe_commands.py uuv_mujoco/current/tools/roll_stability_probe_sequence.py
