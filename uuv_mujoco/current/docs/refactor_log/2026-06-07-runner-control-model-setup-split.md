...
python3 -m py_compile \
  ...
  uuv_mujoco/current/sim/runtime/control_bridge_setup.py \
  uuv_mujoco/current/sim/runtime/model_io_setup.py
```

```text
source ./.uuv_mujoco_env.sh
"$MJ311_PYTHON" uuv_mujoco/current/run_uuv_mujoco.py --help
```
