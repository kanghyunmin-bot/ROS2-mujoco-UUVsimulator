...
- `python3 -m compileall -q uuv_mujoco/current/bridge/ros2_endpoints.py uuv_mujoco/current/bridge/ros2_endpoint_publishers.py uuv_mujoco/current/bridge/ros2_endpoint_subscriptions.py uuv_mujoco/current/bridge/ros2_endpoint_services.py`
- Fake-node endpoint construction:
  - MAVROS enabled: `pubs=40`, `subs=7`, `srvs=3`
  - MAVROS disabled: `pubs=26`, `subs=3`, `srvs=0`
- `python3 -m compileall -q uuv_mujoco/current/sim/physics/hydrostatic_setup.py uuv_mujoco/current/sim/physics/hydrostatic_runtime_types.py uuv_mujoco/current/sim/physics/hydrostatic_runtime_sources.py uuv_mujoco/current/sim/physics/hydrostatic_runtime_values.py uuv_mujoco/current/sim/physics/hydrostatic_runtime_reporting.py`
- `/Users/kanghyunmin/miniconda3/envs/ros2_h311/bin/python uuv_mujoco/current/tools/physics_contract_audit.py --output-dir /private/tmp/uuv_physics_audit_hydrostatic_split --simulate-s 0`
