...
Scope: active runtime under `uuv_mujoco/current`.  The active alias still
...
PYTHONPATH=uuv_mujoco/current/tools python3 uuv_mujoco/current/tools/audit_code_contract_sources.py --out-dir /private/tmp/uuv_source_audit_spaghetti_20260607_mavros_hydro_schedule_actuator_split
...
/Users/kanghyunmin/miniconda3/envs/ros2_h311/bin/python uuv_mujoco/current/tools/physics_contract_audit.py --output-dir /private/tmp/uuv_physics_audit_spaghetti_20260607_mavros_hydro_schedule_actuator_split --simulate-s 0
```
...
- Execution target: `uuv_mujoco/current`
