...
python3 -m compileall -q \
  uuv_mujoco/current/sim/transport/mavlink_command_link.py \
  uuv_mujoco/current/sim/transport/mavlink_command_endpoint.py \
  uuv_mujoco/current/sim/transport/mavlink_command_senders.py \
  uuv_mujoco/current/sim/transport/__init__.py
