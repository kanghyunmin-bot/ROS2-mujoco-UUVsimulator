    ...
    return {
        ...
        **message_imports,
        ...
        "DVLMsg": optional_message_type(
            f"{optional_imports['DVLPackage'] or 'auv_dvl_a50_msg'}/DVL",
            optional_imports["DVLMsg"],
            log=log_optional,
        ),
        "DVLDRMsg": optional_message_type(
            f"{optional_imports['DVLPackage'] or 'auv_dvl_a50_msg'}/DVLDR",
            optional_imports["DVLDRMsg"],
            log=log_optional,
        ),
        "DVLPackage": optional_imports["DVLPackage"],
