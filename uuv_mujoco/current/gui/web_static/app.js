...
function renderSimulationConfig(config, processes) {
  ...
  const selectedConfigId = String(config.selected_preset_id || "research_pool_distributed");
  ...
  const presets = allPresets.filter(preset => advanced
    || preset.id === "research_pool_distributed" || preset.id === visibleId);
  ...
  const selectedId = String(config.selected_preset_id || "research_pool_distributed");
