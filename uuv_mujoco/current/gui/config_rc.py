...
RC_PWM_SPAN = float(os.environ.get("UUV_GUI_RC_PWM_SPAN", "400.0"))
...
REAL_JS_GAIN_MAX = env_float_default("SITL_JS_GAIN_MAX", 1.0)
REAL_JS_GAIN_STEPS = int(env_float_default("SITL_JS_GAIN_STEPS", 1))
