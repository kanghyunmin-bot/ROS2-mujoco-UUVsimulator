...
| `bridge_live_imports` | PASS | 0.226 |
| `json_servo_receiver` | PASS | 0.029 |
| `sitl_servo_runtime` | PASS | 0.046 |
| `immediate_sensor_replay_reply` | PASS | 0.045 |
| `mujoco_velocity_contract` | PASS | 0.091 |
| `sitl_command_link_readiness` | PASS | 0.027 |
| `sitl_external_nav_contract` | PASS | 0.016 |
| `mavlink_message_interval` | PASS | 0.027 |
| `runtime_readiness_policy` | PASS | 0.023 |
| `gui_backend_selection` | PASS | 0.025 |
| `gui_entry_contract` | PASS | 1.126 |
| `gui_start_contract` | PASS | 0.034 |
| `gui_readiness_contract` | PASS | 0.027 |
| `gui_ros_python_contract` | PASS | 0.498 |
...
| `model_runtime_setup` | PASS | 0.394 |
...
| `source_contract_audit` | PASS | 0.382 |
