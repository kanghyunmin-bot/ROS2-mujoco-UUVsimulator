...
def log_mujoco_hydrodynamics_source(*, log: Callable[[str], None]) -> None:
    log(
        "[physics] hydrodynamics source: MuJoCo built-in ellipsoid fluidcoef only; "
        "Python 6DOF added_mass/linear_damping/quadratic_damping is inactive. "
        "Active knobs: hydrostatic buoyancy, CoB torque, thruster tuning, "
