...
def configure_fluid_model_contract(
    *,
    ...
    print(
        "[physics] hydrodynamic contract: MuJoCo ellipsoid fluidcoef owns drag/lift; "
        "Python applies hydrostatic buoyancy/restoring torque and final thruster force only.",
        flush=True,
    )
