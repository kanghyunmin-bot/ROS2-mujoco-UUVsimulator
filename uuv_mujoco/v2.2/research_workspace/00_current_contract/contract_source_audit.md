...
- local evidence:
  ...
  - `uuv_mujoco/current/bridge/ros2_state_sitl_vertical.py:30` - sitl_depth_m_for_frontend_match(pressure_pa)
...
- official refs: <https://bluerobotics.com/store/sensors-cameras/sensors/bar30-sensor-r1-rp/>
- local evidence:
  - `uuv_mujoco/current/bridge/ros2_bridge_config_imu.py:85` - ROS2_UUV_STATIC_PRESSURE_SOURCE", "external"
