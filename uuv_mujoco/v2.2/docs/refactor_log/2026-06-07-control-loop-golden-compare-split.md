...
Scope: active runtime tool code under `uuv_mujoco/current/tools`.
...
python3 -m py_compile \
  uuv_mujoco/current/tools/control_loop_golden_compare.py \
  uuv_mujoco/current/tools/control_loop_golden_math.py \
  uuv_mujoco/current/tools/control_loop_golden_thrusters.py \
  uuv_mujoco/current/tools/control_loop_golden_fingerprint.py \
  uuv_mujoco/current/tools/control_loop_golden_compare_logic.py
python3 uuv_mujoco/current/tools/control_loop_golden_compare.py --help
python3 uuv_mujoco/current/tools/control_loop_golden_compare.py \
  --candidate uuv_mujoco/current/logs/control_loop_golden_smoke_20260519_j_armwait/axis_check/axis_summary.json \
  --baseline uuv_mujoco/current/logs/control_loop_golden_smoke_20260519_j_armwait/axis_check/axis_summary.json \
  --thruster-csv uuv_mujoco/current/logs/control_loop_golden_smoke_20260519_j_armwait/mujoco_thruster_debug.csv \
  --baseline-thruster-csv uuv_mujoco/current/logs/control_loop_golden_smoke_20260519_j_armwait/mujoco_thruster_debug.csv \
