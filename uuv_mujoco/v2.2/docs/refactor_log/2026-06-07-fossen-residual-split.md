...
Scope: active runtime hydrodynamics code under `uuv_mujoco/current/sim/physics`.
...
python3 -m py_compile \
  uuv_mujoco/current/sim/physics/fossen_residual.py \
  uuv_mujoco/current/sim/physics/fossen_residual_types.py \
  uuv_mujoco/current/sim/physics/fossen_residual_builders.py \
  uuv_mujoco/current/sim/physics/fossen_residual_config.py \
  uuv_mujoco/current/sim/physics/fossen_residual_coefficients.py \
  uuv_mujoco/current/sim/physics/fossen_residual_added_mass.py \
  uuv_mujoco/current/sim/physics/fossen_residual_runtime_flags.py \
  uuv_mujoco/current/sim/physics/fossen_residual_wrench.py \
  uuv_mujoco/current/sim/runtime/hydrodynamics_runtime_wrenches.py \
  uuv_mujoco/current/sim/runtime/underwater_hydrodynamics_runtime.py
