...
```text
python3 -m compileall -q uuv_mujoco/current/sim/physics/dynamic_fluidcoef_runtime_knobs.py ...
PYTHONPATH=uuv_mujoco/current python3 - <<'PY'  # fake runtime knob smoke
python3 uuv_mujoco/current/tools/refactor_inventory.py --root uuv_mujoco/current --limit 20
python3 uuv_mujoco/current/tools/check_runtime_freshness.py --workspace /Users/kanghyunmin/Desktop/uuv_sim --runtime-dir /Users/kanghyunmin/Desktop/uuv_sim/uuv_mujoco/current --fetch --refresh-version --warn-only
PYTHONPATH=uuv_mujoco/current/tools python3 uuv_mujoco/current/tools/audit_code_contract_sources.py --out-dir /private/tmp/uuv_source_audit_spaghetti_20260607_fluidcoef_split
