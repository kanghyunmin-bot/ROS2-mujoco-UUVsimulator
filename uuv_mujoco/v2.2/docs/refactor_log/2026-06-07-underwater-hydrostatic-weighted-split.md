...
python3 -m compileall -q \
  uuv_mujoco/current/sim/runtime/underwater_hydrostatic_weighted.py \
  uuv_mujoco/current/sim/runtime/underwater_hydrostatic_accumulator.py \
  uuv_mujoco/current/sim/runtime/underwater_hydrostatic_samples.py \
  uuv_mujoco/current/sim/runtime/underwater_hydrostatic_runtime.py
