...
- local evidence:
  ...
  - `uuv_mujoco/v2.2/bridge/sitl_transport.py:2968` - json_position[2] = float(vertical_est.depth_m)
...
- official refs: <https://ardupilot.org/dev/docs/sitl-with-JSON.html>
- local evidence:
  - `uuv_mujoco/v2.2/bridge/sitl_transport.py:2972` - "altitude": float(vertical_est.alt_m)
