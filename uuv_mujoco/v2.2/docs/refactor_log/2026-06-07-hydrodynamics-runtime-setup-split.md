...
Scope: active MuJoCo runtime setup under `uuv_mujoco/current/sim/runtime`.
...
python3 -m py_compile \
  uuv_mujoco/current/sim/runtime/hydrodynamics_runtime_setup.py \
  uuv_mujoco/current/sim/runtime/hydrodynamics_runtime_types.py \
  uuv_mujoco/current/sim/runtime/hydrodynamics_runtime_values.py \
  uuv_mujoco/current/sim/runtime/hydrodynamics_runtime_wrenches.py \
  uuv_mujoco/current/sim/runtime/hydrodynamics_runtime_logging.py \
