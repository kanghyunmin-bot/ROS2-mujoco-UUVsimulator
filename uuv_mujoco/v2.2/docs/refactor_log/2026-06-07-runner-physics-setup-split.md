...
- `python3 -m compileall -q uuv_mujoco/current/sim/runtime/runner_physics_setup.py uuv_mujoco/current/sim/runtime/runner_control_path_log.py uuv_mujoco/current/sim/runtime/runner_fluid_contract_setup.py uuv_mujoco/current/sim/runtime/runner_model_io_contract.py uuv_mujoco/current/sim/runtime/runner_runtime_physics_contract.py`
