...
PYTHONPATH=uuv_mujoco/current/tools python3 uuv_mujoco/current/tools/audit_code_contract_sources.py --out-dir /private/tmp/uuv_code_contract_after_autotune_ping360_devos_split
source ./.uuv_mujoco_env.sh && PYTHONPATH=uuv_mujoco/current/tools "$MJ311_PYTHON" uuv_mujoco/current/tools/physics_contract_audit.py --output-dir /private/tmp/uuv_physics_contract_after_autotune_ping360_devos_split --simulate-s 0
