...
python3 -m compileall -q \
  ...
  uuv_mujoco/current/tools/runtime_freshness_issue.py \
  uuv_mujoco/current/tools/runtime_freshness_runtime_checks.py \
  uuv_mujoco/current/tools/runtime_freshness_source_checks.py \
  uuv_mujoco/current/tools/runtime_freshness_dirty_checks.py \
  uuv_mujoco/current/tools/runtime_freshness_version_checks.py \
