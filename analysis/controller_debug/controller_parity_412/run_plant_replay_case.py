...
ROOT = WORKSPACE_ROOT / "sim" / "current"
DEBUG_ROOT = Path(__file__).resolve().parent
DEFAULT_REAL_CSV = DEBUG_ROOT / "real_20260401_feedback/real_controller_feedback_20hz.csv"
...
def main() -> int:
    ...
    probe_args = [
        str(DEBUG_ROOT / "plant_replay_sensor_probe.py"),
        "--real-csv",
        str(real_csv),
        "--input-csv",
        str(input_csv),
    ...
    plot_cmd = [
        "python3",
        str(DEBUG_ROOT / "plot_plant_sensor_overlay.py"),
        "--real-csv",
        str(real_csv),
        "--sim-csv",
        str(sim_csv),
    ...
    audit_cmd = [
        "python3",
        str(DEBUG_ROOT / "audit_plant_sensor_contract.py"),
        "--real-csv",
        str(real_csv),
        "--plant-input-csv",
        str(input_csv),
