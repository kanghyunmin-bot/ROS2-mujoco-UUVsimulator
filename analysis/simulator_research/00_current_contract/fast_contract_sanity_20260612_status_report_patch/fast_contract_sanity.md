...
| `gui_readiness_contract` | PASS | 0.038 |
| `gui_ros_python_contract` | PASS | 0.917 |
| `gui_arm_mode_command_contract` | PASS | 0.023 |
...
| `model_runtime_setup` | PASS | 0.450 |
...
| `source_contract_audit` | PASS | 0.427 |
