...
| Step | Status | Seconds |
| --- | --- | ---: |
| `compileall_core` | PASS | 0.169 |
| `rc_frame_contract` | PASS | 0.069 |
| `ros2_command_payload` | PASS | 0.018 |
| `bridge_live_imports` | PASS | 0.223 |
| `json_servo_receiver` | PASS | 0.042 |
| `sitl_servo_runtime` | PASS | 0.045 |
| `immediate_sensor_replay_reply` | PASS | 0.046 |
| `mujoco_velocity_contract` | PASS | 0.088 |
...
| `gui_ros_python_contract` | PASS | 0.490 |
...
| `model_runtime_setup` | PASS | 0.412 |
...
| `source_contract_audit` | PASS | 0.445 |
