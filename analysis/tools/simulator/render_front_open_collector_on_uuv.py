...
SCENE = ROOT / "sim" / "current" / "scenes" / "tank_current_scene.xml"
OUT_DIR = ROOT / "analysis" / "generated_meshes" / "previews"
...
def write_temp_scene() -> None:
    ...
    if compiler is not None:
        compiler.set("meshdir", str(ROOT / "sim" / "current" / "assets" / "urdf_full" / "meshes_split"))
