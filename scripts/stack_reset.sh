...
ps -ef | grep -E "sim_vehicle.py -v ArduSub|/build/sitl/bin/ardusub|run_urdf_full.py --scene competition_scene.xml|QGroundControl-x86_64.AppImage" | grep -v grep || true

echo "[reset] UDP/TCP ports in use (9002/9003/14550/5760):"
ss -uapn | grep -E "9002|9003|14550" || true
ss -tapn | grep -E "5760" || true
