...
### Dependencies
- [auv_dvl_a50_msg](https://github.com/paagutie/auv_dvl_a50_msg)
...
$ mkdir -p ~/ros2_ws/src
$ cd ~/ros2_ws/src
$ git clone https://github.com/paagutie/auv_dvl_a50_msg.git
...
$ ros2 run auv_dvl_a50 dvl_a50.py --ros-args -p ip_address:='192.168.194.95'
```
...
$ cd ~/ros2_ws
$ source install/setup.bash
$ ros2 run auv_dvl_a50 auv_dvl_a50_sensor --ros-args -p dvl_ip_address:='192.168.2.95'
or
$ ros2 launch auv_dvl_a50 dvl_a50.launch.py ip_address:='192.168.194.95'
```
...
$ cd ~/ros2_ws
$ source install/setup.bash
$ ros2 launch auv_dvl_a50 dvl_composition.launch.py ip_address:='192.168.194.95'
```
