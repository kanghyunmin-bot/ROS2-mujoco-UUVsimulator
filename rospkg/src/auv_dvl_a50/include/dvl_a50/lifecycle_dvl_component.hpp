...
private:
  ...
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<auv_dvl_a50_msg::msg::DVL>> dvl_pub_report;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<auv_dvl_a50_msg::msg::DVLDR>> dvl_pub_pos;
