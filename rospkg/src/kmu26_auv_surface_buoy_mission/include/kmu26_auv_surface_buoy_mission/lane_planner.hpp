...
struct ArenaConfig
{
  ...
  LaneOrientation lane_orientation{LaneOrientation::HORIZONTAL};
  bool circular_exclusion_enabled{false};
  Vec2 circular_exclusion_center{};
  double circular_exclusion_radius_m{0.0};
  double min_lane_segment_length_m{0.0};
};
...
private:
  void append_lane(const Vec2 & endpoint_a, const Vec2 & endpoint_b);
